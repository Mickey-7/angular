...
export class ImageService {
  ...
  //create a blank array of images
  visibleImages=[]


  //get all images
  getImages(){
    //note that if the method is get, there should be a return
    return this.visibleImages = IMAGES.slice(0)
    // .slice(start, end) return a section of array 
  }

  //get specific image bu id
  getImage(id: number){
